...
Feature: Shipping with new created user account
  Scenario: Create a new account with email and user information
    ...
    When Write to "firstName12@gmail.com" on "email_create" field
  ...
  Scenario: Shipping a product with newly created user account
    ...
    When Click to "/html/body/div/div[1]/header/div[2]/div/div/nav/div[1]/a" with xpath
    Then Check "Login - My Store" actual page title is true
    When Write to "firstName8@gmail.com" on "email" field
    And Write to "password" on "passwd" field
...
#    When Select to '//*[@id="center_column"]/ul/li[3]/div/div[2]/div[2]/a[1]' from '//*[@id="center_column"]/ul/li[3]/div/div[1]/div/a[1]/img' with hover
#    When Select to '//*[@id="center_column"]/ul/li[3]/div/div[1]/div/a[2]' from '//*[@id="center_column"]/ul/li[3]/div/div[1]/div/a[1]/img' with hover
    ...
    And Check product name '//*[@id="product_7_34_0_458631"]/td[2]/p/a', quantity '//*[@id="product_7_34_0_458631"]/td[5]/input[2]' and price "total_product"
